  ...
  categories: [
    {
      ...
      featured: [
        ...
        {
          name: 'Netflix',
          href: '/products?category_id=5',
          imageSrc: '/public/netflix.jpg',
          imageAlt:
            'Netflix.',
        },
      ],
      sections : [
        {
          ...
          name: "Account",
          items: [
            { name: "Spotify", href: "/products?category_id=3" },
            { name: "Youtube", href: "/products?category_id=4" },
            { name: "Netflix", href: "/products?category_id=5" },
          ],
        }
      ]
    },
          ...
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                ...
                {
                  auth.isLogged ? (<div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                    <Link href="/orders" className="text-sm font-medium text-gray-700 hover:text-gray-800">
                      Hello, {auth.user.fullname}
                    </Link>
                    <span className="h-6 w-px bg-gray-200" aria-hidden="true" />
                    <Link href="/" className="text-sm font-medium text-gray-700 hover:text-gray-800" onClick={auth.logout}>
                      Sign out
                    </Link>
                  </div>) : (
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  <Link href="/cart" className="group -m-2 flex items-center p-2">
                    <ShoppingBagIcon
                      ...
                      aria-hidden="true"
                    />
                    <span className="ml-2 text-sm font-medium text-gray-700 group-hover:text-gray-800">{getCartTotalQuantity()}</span>
