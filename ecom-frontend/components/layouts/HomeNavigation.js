      ...
      featured: [
        {
          ...
          imageAlt: 'Spotfy Premium',
        },
        {
          name: 'Youtube Premium Upgrade',
          href: '/products?category_id=4',
          imageSrc: '/public/youtube.jpg',
          imageAlt: 'Youtube Premium',
        },
        {
          name: 'Netflix Shared Slot',
            ...
            <div className="bg-gray-900">
              <div className="mx-auto flex h-10 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center space-x-6">
                  {
                    auth.isLogged ? (<>
                      <Link href="/orders" className="text-sm font-medium text-white hover:text-gray-100">
                        Hello, {auth.user.fullname}
                      </Link>
                      <Link href="/" className="text-sm font-medium text-white hover:text-gray-100" onClick={auth.logout}>
                        Sign out
                      </Link>
                    </>) : (<>
                      <Link href="/sign-in" className="text-sm font-medium text-white hover:text-gray-100">
                        Sign in
                      </Link>
                      <Link href="/sign-up" className="text-sm font-medium text-white hover:text-gray-100">
                        Create an account
                      </Link></>)
                  }
